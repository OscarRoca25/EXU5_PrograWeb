    ...
    <div class="container">
        ...
        <div id="contenendorformulario" class="container" style="background-color: rgb(161, 217, 255);">
            <header class="card-header  text-center ">
                <h1 class=" p-3">Articulos Recomendado</h1>
            </header>
            <table id="tablita" class="table table-striped ">
                <tbody>
                    ...
                    $db = mysqli_connect($servidor, $usuarioBD, $pwBD, $nomBD);   
                        ...
                        $sql = "SELECT id_articulo, titulo, subtitulo, correo, fecha_publicacion, categoria FROM articulos WHERE titulo = 'La paradoja más famosa de la física se acerca a su fin'";

    ...
    <div class="container">
        ...
        <div id="contenendorformulario" class="container" style="background-color: rgb(161, 217, 255);">
            <header class="card-header  text-center ">
                <h1 class=" p-3">Articulos de Cat. Perspectiva</h1>
            </header>
            <table id="tablita" class="table table-striped ">
                <tbody>
                    ...
                    $db = mysqli_connect($servidor, $usuarioBD, $pwBD, $nomBD);                                            
                        $sql = "SELECT id_articulo, titulo, subtitulo, correo, fecha_publicacion, categoria FROM articulos WHERE categoria = 'Perspectiva'";
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                <a href="ver.php?id=<?php echo $Id_articulo ?>"><img class="d-block w-100" src="img/PERSPECTIVA.jpg" alt="Third slide"> </a>
